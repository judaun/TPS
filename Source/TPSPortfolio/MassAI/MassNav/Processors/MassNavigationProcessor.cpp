...
#include "MassAI/MassNav/Processors/MassNavigationProcessor.h"
...
UMassNavigationProcessor::UMassNavigationProcessor()
	: EntityQuery(*this)
{
...
void UMassNavigationProcessor::ConfigureQueries()
{
...
void UMassNavigationProcessor::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& Context)
{
